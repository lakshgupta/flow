...
- Skills
    ...
    - fix [skills.md](http://skills.md) file generated by flow. Install [skills.md](http://skills.md) file automatically in the global space - ~/.agents/skills/ — designed and implemented (20260805-001-FEAT-skills-packaging-init): `flow skill init` writes all embedded skills to `~/.agents/skills/` (or `.agents/skills/` with `--project`); pending tests and commit
